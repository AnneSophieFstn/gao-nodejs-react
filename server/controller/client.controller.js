...
async function editCLient(req, res) {
  try {
    ...
    const editCLient = await Client.findByIdAndUpdate(req.params.clientId, {
      firstname: req.query.firstname,
      lastname: req.query.lastname,
    });
...
async function deleteCLient(req, res) {
  try {
    const deleteClient = await Client.findByIdAndDelete(req.params.clientId);
